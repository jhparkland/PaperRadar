...
export const MESSAGES = {
  ko: {
    ...
    'changes.title': '📡 {title} · 일정 변경',
    'changes.subtitle': '{count}건이 바뀌었습니다',
    'changes.added': '🆕 확정', 'changes.confirmed': '🆕 확정 (TBA → 날짜)', 'changes.changed': '🔁 변경',
    'changes.removed': '❌ 삭제', 'changes.recovered': '✅ 재확인 성공', 'changes.failed': '⚠ 확인 실패',
  ...
  en: {
    ...
    'changes.title': '📡 {title} · Schedule changes',
    'changes.subtitle': '{count} change(s) detected',
    'changes.added': '🆕 New', 'changes.confirmed': '🆕 Announced (TBA → date)', 'changes.changed': '🔁 Changed',
    'changes.removed': '❌ Removed', 'changes.recovered': '✅ Verified again', 'changes.failed': '⚠ Verification failed',
