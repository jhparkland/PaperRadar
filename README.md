...
사이트를 보러 가지 않아도 [Google Chat으로 하루 한 번](#알림은-언제-어떻게-오나) 요약이 옵니다.
...
![Google Chat으로 온 마감 다이제스트](docs/images/chat-digest.png)

<sub>실제로 도착한 메시지. 분류별로 묶이고, 각 줄에 공식 시각·KST 환산·CFP 버튼이 붙습니다.</sub>
